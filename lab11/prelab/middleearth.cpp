...
/** @brief Iluvatar, the creator of Middle-Earth (Constructor)
 *
 ...
 * @param xsize used to compute # of columns for 2D array for cities (Middle-Earth)
 * @param ysize used to compute # of rows for 2D array for cities (Middle-Earth)
 * @param num_cities number of cities
 * @param seed used to set up the random number seed
 */
...
/** @brief Sauron, the destructor of Middle-Earth (Destructor)
 *
 * deletes Middle-Earth
 */
 ...
 *
 * prints the cities in the world you created
 */
 ...
 *
 * prints the distances between cities (this can be loaded into Excel or similar)
 */
 ...
 * @param length # of cities you would like
