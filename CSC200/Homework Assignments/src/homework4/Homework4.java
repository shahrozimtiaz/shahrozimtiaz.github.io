...
public class Homework4 {
	...
	public static void main(String[] args) 
	{
		...
		wallArea = wallAreaMethod(length,height,width,windowArea,doorArea,bookShelfWallArea);  //calculating wall area
		floorArea = floorAreaMethod(length,width,bookShelfFloorArea); //calculating floor area
...
////////////// Repeats everything but for the walls ////////////////////////
		...
		public static double wallAreaMethod(double length, double height, double width, double windowArea, double doorArea, double bookShelfWallArea)//method for wall area
		{
			
			return (((2*(length*height))+(2*(width*height)))-windowArea-doorArea-bookShelfWallArea); //calculating wall area
		}
		
		public static double floorAreaMethod(double length, double width, double bookShelfFloorArea)//method for floor area
		{
			
			return (length*width)-bookShelfFloorArea; //calculation floorarea
		}
