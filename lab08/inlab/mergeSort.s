...
_mergeSort:
	...
	cmp rdx,rsi    ;if(l>=r) return, else mergesort  BASE CASE
	jg startMS     ;.
	jmp doneM      ;.
startMS:
	mov rax,rsi    ;middle = (l+r)/2
	add rax,rdx    ;. (l+r)
 	shr rax,1      ;.  /2 
 	mov r11,rax    ;r11 will now store middle value    
 	push rdx       
	mov rdx,r11    ;rightEnd = middle
	push r11
	call _mergeSort ;call mergeSort on left array
	pop r11
	pop rdx
	push rsi       ;leftEnd = middle + 1
	mov rsi,r11
	add rsi,1
	push r11
	call _mergeSort ;call mergeSort on right array
	pop r11
	pop rsi
	push rcx        
	mov rcx,rdx    ;move parameter3->parameter 4
	push rdx
	mov rdx,r11    ;move middle->parameter3
	push r11
	call _merge    ;merge
	pop r11
	pop rdx
...
doneM:
	; Standard epilogue
	pop r11      ;restore original register value
	ret
